...
- **Long-press para drag**: Los items requieren mantener presionado ~400ms antes de poder arrastrarlos. Esto evita que un swipe rápido sobre un item arrastre el item en vez de hacer scroll del día.
